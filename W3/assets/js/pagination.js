...
const BTN_LEFT_first = document.querySelector("#arrow_left");
const BTN_LEFT_second = document.querySelector("#arrow_left_double");
const BTN_RIGHT_first = document.querySelector("#arrow_right");
const BTN_RIGHT_second = document.querySelector("#arrow_right_double");
